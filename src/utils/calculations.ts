import { Stock, Portfolio, TradeRecommendation, PortfolioMetrics, SectorAllocation, ProjectedReturns, Sector } from '../types/portfolio';
...
export const generateTradeRecommendations = (portfolio: Portfolio): TradeRecommendation[] => {
  ...
  portfolio.stocks.forEach(stock => {
    ...
    // Only create recommendations for significant imbalances
    const imbalanceThreshold = totalValue * 0.005; // 0.5% threshold
